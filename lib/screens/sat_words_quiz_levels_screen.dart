...
class SATWordsQuizLevelsScreen extends StatelessWidget {
  const SATWordsQuizLevelsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('SAT Words Quiz'),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            _levelCard(
              context,
              title: 'Beginner',
              subtitle: 'Start with basic SAT vocabulary',
            ...
            _levelCard(
              context,
              title: 'Intermediate',
              subtitle: 'Practice stronger SAT words',
            ...
            _levelCard(
              context,
              title: 'Advanced',
              subtitle: 'Challenge yourself with harder words',
